...
HashTreeNode* hashtree_new(void)
{
    ...
    cleanup_register(tmp, hashtree_destroy);
    return tmp;
}
...
static void hashtree_compare_int(HashTreeNode* old, HashTreeNode* new, const char **ptr)
{
    unsigned int i;
    const char *hash;
...
{
    const char **table = calloc(1024, sizeof(char*)); /*TODO*/
    ...
    hashtree_compare_int(old, new, table);
